						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="General pages">
								...
								<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
									...
									<ul class="nav nav-group-sub">
										<li class="nav-item"><a href="blog_classic_v.html" class="nav-link active">Classic vertical</a></li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Blog</span> - Vertical Layout</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="blog_classic_v.html" class="breadcrumb-item">Blog</a>
					...
					<div class="col-md-6">
						...
						<div class="card">
							...
							<div class="card-footer bg-transparent d-sm-flex justify-content-sm-between align-items-sm-center border-top-0 pt-0 pb-3">
								...
								<a href="#" class="btn bg-teal">Read more <i class="icon-arrow-right14 ml-2"></i></a>
							</div>
						</div>
						<!-- /blog layout #3 with image -->
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center">
									...
									<a href="#" class="btn btn-primary">Read more <i class="icon-arrow-right14 ml-2"></i></a>
								</div>
							</div>
						</div>
						<!-- /blog layout #5 with image -->
