					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Basic components">
								...
								<li class="nav-item"><a href="components_pills.html" class="nav-link active">Pills component</a></li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Components</span> - Pills</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="components_pills.html" class="breadcrumb-item">Components</a>
						...
						<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-pills nav-pills-bordered">
									<li class="nav-item"><a href="#bordered-pill1" class="nav-link active" data-toggle="tab">Active</a></li>
						...
						<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-pills nav-pills-bordered nav-justified">
									<li class="nav-item"><a href="#bordered-justified-pill1" class="nav-link active" data-toggle="tab">Active</a></li>
						...
						<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-pills nav-pills-bordered nav-pills-toolbar">
									<li class="nav-item"><a href="#toolbar-pill1" class="nav-link active" data-toggle="tab">Active</a></li>
						...
						<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-pills justify-content-center">
									<li class="nav-item"><a href="#centered-pill1" class="nav-link active" data-toggle="tab">Active</a></li>
						...
						<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-pills justify-content-end">
									<li class="nav-item"><a href="#right-pill1" class="nav-link active" data-toggle="tab">Active</a></li>
						...
						<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-pills flex-column">
									<li class="nav-item"><a href="#stacked-icons-pill1" class="nav-link active" data-toggle="tab">Active</a></li>
					...
					<div class="col-md-6">
						<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-pills flex-column">
									<li class="nav-item">
										<a href="#stacked-badges-pill1" class="nav-link active" data-toggle="tab">
						...
						<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-pills nav-pills-bordered flex-column">
									<li class="nav-item">
										<a href="#stacked-bordered-pill1" class="nav-link active" data-toggle="tab">
											<i class="icon-menu7 mr-2"></i>
											Active
										</a>
									</li>
						...
						<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-pills nav-pills-bordered nav-pills-toolbar flex-column">
									<li class="nav-item">
										<a href="#stacked-bordered-toolbar-badges-pill1" class="nav-link active" data-toggle="tab">
											<i class="icon-menu7 mr-2"></i>
											Active
										</a>
									</li>
							...
							<div class="card-body">
								<div class="d-lg-flex justify-content-lg-between">
									...
									<ul class="nav nav-pills flex-column ml-lg-3 wmin-lg-250 mt-3 mt-lg-0 mb-0">
										<li class="nav-item">
											<a href="#stacked-right-pill1" class="nav-link active" data-toggle="tab">
												<i class="icon-menu7 mr-2"></i>
												Active
											</a>
										</li>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-pills">
									<li class="nav-item"><a href="#left-icon-pill1" class="nav-link active" data-toggle="tab"><i class="icon-menu7 mr-2"></i> Active</a></li>
					...
					<div class="col-md-6">
						<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-pills nav-justified">
									<li class="nav-item"><a href="#justified-left-icon-pill1" class="nav-link active" data-toggle="tab"><i class="icon-menu7 mr-2"></i> Active</a></li>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-pills">
									<li class="nav-item"><a href="#right-icon-pill1" class="nav-link active" data-toggle="tab">Active <i class="icon-menu7 ml-2"></i></a></li>
					...
					<div class="col-md-6">
						<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-pills nav-justified">
									<li class="nav-item"><a href="#justified-right-icon-pill1" class="nav-link active" data-toggle="tab">Active <i class="icon-menu7 ml-2"></i></a></li>
					...
					<div class="col-md-6">
						<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-pills">
									<li class="nav-item">
										<a href="#icon-only-pill1" class="nav-link active" data-toggle="tab">
					...
					<div class="col-md-6">
						<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-pills nav-justified">
									<li class="nav-item">
										<a href="#justified-icon-only-pill1" class="nav-link active" data-toggle="tab">
											<i class="icon-menu7"></i>
											<span class="d-md-none ml-2">Active</span>
										</a>
									</li>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-pills">
									<li class="nav-item"><a href="#badge-pill1" class="nav-link active" data-toggle="tab"><span class="badge bg-grey-700 mr-2">Bug</span> Active</a></li>
					...
					<div class="col-md-6">
						<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-pills nav-justified">
									<li class="nav-item"><a href="#justified-badge-pill1" class="nav-link active" data-toggle="tab"><span class="badge bg-grey-700 mr-2">Bug</span> Active</a></li>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-pills">
									<li class="nav-item"><a href="#pill-badges-pill1" class="nav-link active" data-toggle="tab"><span class="badge bg-purple-400 mr-2">62</span> Active</a></li>
					...
					<div class="col-md-6">
						<div class="card">
							...
							<div class="card-body">
								<ul class="nav nav-pills nav-justified">
									<li class="nav-item"><a href="#justified-badges-pill1" class="nav-link active" data-toggle="tab"><span class="badge bg-purple-400 mr-2">62</span> Active</a></li>
