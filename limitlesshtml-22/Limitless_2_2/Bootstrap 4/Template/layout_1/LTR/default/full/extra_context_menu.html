					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Extra components">
								...
								<li class="nav-item"><a href="extra_context_menu.html" class="nav-link active">Context menu</a></li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Extra</span> - Context Menu</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="extra_context_menu.html" class="breadcrumb-item">Extra</a>
					...
					<div class="col-md-6">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="context-element-menu">
									<div class="dropdown-menu">
										<a href="#" class="dropdown-item"><i class="icon-copy4"></i> Copy</a>
										<a href="#" class="dropdown-item"><i class="icon-paste3"></i> Paste</a>
										<a href="#" class="dropdown-item"><i class="icon-file-minus"></i> Remove</a>
					...
					<div class="col-md-6">
						...
						<div class="card">
							...
							<div class="card-body context-deactivate">
								...
								<div class="context-deactivate-menu">
									<div class="dropdown-menu">
										<a href="#" class="dropdown-item"><i class="icon-copy4"></i> Copy</a>
										<a href="#" class="dropdown-item"><i class="icon-paste3"></i> Paste</a>
										<a href="#" class="dropdown-item"><i class="icon-file-minus"></i> Remove</a>
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="card">
							...
							<div class="context-table-content">
								<div class="dropdown-menu">
									<a href="#" class="dropdown-item"><i class="icon-copy4"></i> Copy</a>
									<a href="#" class="dropdown-item"><i class="icon-paste3"></i> Paste</a>
									<a href="#" class="dropdown-item"><i class="icon-file-minus"></i> Remove</a>
					...
					<div class="col-md-6">
						...
						<div class="card">
							...
							<div class="card-body" data-toggle="context" data-target=".context-options-menu">
								...
								<div class="context-options-menu">
