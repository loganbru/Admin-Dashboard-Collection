							...
							<ul class="nav nav-group-sub" data-submenu-title="General pages">
								...
								<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
									...
									<ul class="nav nav-group-sub">
										...
										<li class="nav-item"><a href="timelines_center.html" class="nav-link active">Centered timeline</a></li>
									</ul>
								</li>
								<li class="nav-item nav-item-submenu">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Timelines</span> - Center Alignment</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="timelines_center.html" class="breadcrumb-item">Timelines</a>
						...
						<div class="timeline-row timeline-row-left">
							...
							<div class="card border-left-3 border-left-danger rounded-left-0">
								<div class="card-body">
									<div class="d-sm-flex align-item-sm-center flex-sm-nowrap">
										<div>
											<h6 class=""><a href="task_manager_detailed.html">#23. New icons set for an iOS app</a></h6>
