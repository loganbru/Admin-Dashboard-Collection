					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Basic components">
								...
								<li class="nav-item"><a href="components_dropdowns.html" class="nav-link active">Dropdown menus</a></li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Components</span> - Dropdowns</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="components_dropdowns.html" class="breadcrumb-item">Components</a>
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-lg-4">
						<div class="card card-body border-top-info">
							<div class="text-center">
								<h6 class="font-weight-semibold mb-0">Menu without border</h6>
								<p class="mb-3 text-muted">Hide border using <code>.border-0</code> class</p>
							</div>

							<div class="dropdown-menu border-0" style="display: block; position: static; width: 100%; margin-top: 0; float: none; z-index: auto;">
								<a href="#" class="dropdown-item">Action</a>
					...
					<div class="col-lg-4">
						<div class="card card-body border-top-info">
							...
							<div class="dropdown-menu border-slate-700 rounded-0" style="display: block; position: static; width: 100%; margin-top: 0; float: none; z-index: auto;">
					...
					<div class="col-lg-4">
						<div class="card card-body border-top-info">
							...
							<div class="dropdown-menu border-2 border-primary rounded-0" style="display: block; position: static; width: 100%; margin-top: 0; float: none; z-index: auto;">
								<a href="#" class="dropdown-item">Action</a>
								<a href="#" class="dropdown-item active">Active menu item</a>
								<a href="#" class="dropdown-item disabled">Something else here</a>
								<div class="dropdown-divider"></div>
