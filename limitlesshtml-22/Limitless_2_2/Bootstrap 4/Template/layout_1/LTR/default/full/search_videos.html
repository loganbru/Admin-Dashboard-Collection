							...
							<ul class="nav nav-group-sub" data-submenu-title="Application pages">
								...
								<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
									...
									<ul class="nav nav-group-sub">
										...
										<li class="nav-item"><a href="search_videos.html" class="nav-link active">Video search results</a></li>
									</ul>
								</li>
								<li class="nav-item nav-item-submenu">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Search</span> - Videos</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="search_videos.html" class="breadcrumb-item">Search</a>
			...
			<div class="content">
				...
				<div class="nav-tabs-responsive mb-3">
					<ul class="nav nav-tabs nav-tabs-bottom flex-nowrap mb-0">
						<li class="nav-item"><a href="search_basic.html" class="nav-link"><i class="icon-display4 mr-2"></i> Website</a></li>
						<li class="nav-item"><a href="search_users.html" class="nav-link"><i class="icon-people mr-2"></i> Users</a></li>
						<li class="nav-item"><a href="search_images.html" class="nav-link"><i class="icon-image2 mr-2"></i> Images</a></li>
						<li class="nav-item"><a href="search_videos.html" class="nav-link active"><i class="icon-file-play mr-2"></i> Videos</a></li>
