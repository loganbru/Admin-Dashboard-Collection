					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Event calendars">
								...
								<li class="nav-item"><a href="fullcalendar_formats.html" class="nav-link active">Language and time</a></li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Fullcalendar</span> - Formats</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="fullcalendar_formats.html" class="breadcrumb-item">Fullcalendar</a>
						...
						<div class="header-elements">
							<form action="#">
								<div class="form-group mb-0">
									<select id="lang-selector" class="form-control form-control-select2" data-container-css-class="bg-slate-700" data-dropdown-css-class="bg-slate-700" data-placeholder="Select language" data-fouc></select>
								</div>
							</form>
	                	</div>
					</div>
