							...
							<ul class="nav nav-group-sub" data-submenu-title="General pages">
								...
								<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
									...
									<ul class="nav nav-group-sub">
										...
										<li class="nav-item"><a href="blog_single.html" class="nav-link active">Single post</a></li>
										<li class="nav-item-divider"></li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Blog</span> - Single</h4>
