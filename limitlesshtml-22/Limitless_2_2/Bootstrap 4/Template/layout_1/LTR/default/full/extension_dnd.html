					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Extensions">
								...
								<li class="nav-item"><a href="extension_dnd.html" class="nav-link active">Drag and drop</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Extensions</span> - Drag and Drop</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="extension_dnd.html" class="breadcrumb-item">Extensions</a>
								...
								<div class="card-body">
									<div class="tabbable">
										<ul class="nav nav-tabs nav-tabs-highlight" id="tabs-target-left">
											<li class="nav-item">
												<a href="#highlight-tab1" class="nav-link active" data-toggle="tab">
								...
								<div class="card-body">
									<div class="tabbable">
										<ul class="nav nav-tabs nav-tabs-solid bg-slate-700 border-0 rounded" id="tabs-solid-target-left">
											<li class="nav-item">
												<a href="#solid-rounded-tab1" class="nav-link active" data-toggle="tab">
													<i class="icon-menu7 mr-2"></i>
													Active tab
												</a>
											</li>
								...
								<div class="card-body">
									<div class="tabbable">
										<ul class="nav nav-tabs nav-tabs-solid bg-slate-700 border-0 rounded nav-justified" id="tabs-solid-target-right">
											<li class="nav-item">
												<a href="#solid-rounded-justified-tab1" class="nav-link active" data-toggle="tab">
													<i class="icon-menu7 mr-2"></i>
													Active tab
												</a>
											</li>
								...
								<div class="card-body">
									<div class="tabbable">
										<ul class="nav nav-pills nav-justified" id="pills-target-right">
											<li class="nav-item">
												<a href="#justified-pill1" class="nav-link active" data-toggle="tab">
													<i class="icon-menu7 mr-2"></i>
													Active pill
												</a>
											</li>
								...
								<div class="card-body">
									<div class="tabbable">
										<ul class="nav nav-pills nav-pills-toolbar nav-pills-bordered nav-justified" id="pills-toolbar-target-right">
											<li class="nav-item">
												<a href="#toolbar-justified-pill1" class="nav-link active" data-toggle="tab">
													<i class="icon-menu7 mr-2"></i>
													Active pill
												</a>
											</li>
