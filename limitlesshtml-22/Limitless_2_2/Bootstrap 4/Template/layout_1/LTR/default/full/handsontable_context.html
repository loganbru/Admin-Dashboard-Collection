					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Handsontable">
								...
								<li class="nav-item"><a href="handsontable_context.html" class="nav-link active">Context menu</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Handsontable</span> - Context Menu</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="handsontable_context.html" class="breadcrumb-item">Handsontable</a>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						<p class="mb-3">The following example demonstrates custom context menu configuration. For greatest configurability, you use <code>contextMenu</code> option as a configuration object as described in <a href="http://medialize.github.com/jQuery-contextMenu/docs.html" target="_blank">jQuery contextMenu documentation</a>. This example shows how to set <strong>custom text</strong>, how to disable <strong>"Remove row"</strong> and <strong>"Insert row above"</strong> for the first row and how to add your <strong>own option</strong>.</p>
