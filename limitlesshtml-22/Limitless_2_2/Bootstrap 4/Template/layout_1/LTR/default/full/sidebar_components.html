					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Sidebars">
								...
								<li class="nav-item-divider"></li>
								<li class="nav-item"><a href="sidebar_components.html" class="nav-link active">Sidebar components</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
						...
						<div class="tab-pane fade active show" id="components-tab">
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="row row-tile no-gutters">
										<div class="col-6">
											<button type="button" class="btn btn-dark btn-block btn-float border-light-alpha m-0 border-top-0 border-left-0">
												<i class="icon-firefox text-warning-600 icon-2x"></i>
												<span>Firefox</span>
											</button>

											<button type="button" class="btn btn-dark btn-block btn-float border-light-alpha m-0 border-bottom-0 border-left-0">
										...
										<div class="col-6">
											<button type="button" class="btn btn-dark btn-block btn-float border-light-alpha m-0 border-top-0 border-right-0">
												<i class="icon-IE text-blue icon-2x"></i>
												<span>Edge</span>
											</button>

											<button type="button" class="btn btn-dark btn-block btn-float border-right-alpha m-0 border-bottom-0 border-right-0">
								...
								<div class="card-body p-0">
									<ul class="nav nav-sidebar" data-nav-type="accordion">
										<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
											...
											<ul class="nav nav-group-sub" data-submenu-title="Navbars">
												<li class="nav-item"><a href="navbar_single.html" class="nav-link active">Single navbar</a></li>
												<li class="nav-item"><a href="navbar_multiple_navbar_navbar.html" class="nav-link">Navbar + navbar</a></li>
												<li class="nav-item"><a href="navbar_multiple_navbar_header.html" class="nav-link">Navbar + header</a></li>
												<li class="nav-item"><a href="navbar_multiple_header_navbar.html" class="nav-link">Header + navbar</a></li>
												<li class="nav-item"><a href="navbar_multiple_top_bottom.html" class="nav-link">Top + bottom</a></li>
											</ul>
										</li>
										<li class="nav-item nav-item-submenu">
											<a href="#" class="nav-link"><i class="icon-sort"></i> <span>Vertical navigation</span></a>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="sidebar_components.html" class="breadcrumb-item">Sidebars</a>
