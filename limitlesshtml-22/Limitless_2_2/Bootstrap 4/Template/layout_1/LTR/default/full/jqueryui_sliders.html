					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="jQuery UI">
								...
								<li class="nav-item"><a href="jqueryui_sliders.html" class="nav-link active">Sliders</a></li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">jQuery UI</span> - Sliders</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="jqueryui_sliders.html" class="breadcrumb-item">jQuery UI</a>
				...
				<div class="row">
					...
					<div class="col-md-4">
						...
						<div class="card card-body border-top-primary text-center">
							...
							<p class="mb-3 text-muted">Using <code>ui-slider-solid</code> class</p>

							<div class="d-flex justify-content-center jui-slider-vertical-handle-default">
								<span class="ui-slider-vertical ui-slider-primary ui-slider-solid ui-slider-lg" data-fouc>70</span>
								<span class="ui-slider-vertical ui-slider-danger ui-slider-solid" data-fouc>52</span>
								<span class="ui-slider-vertical ui-slider-success ui-slider-solid ui-slider-sm" data-fouc>80</span>
							</div>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="card card-body border-top-primary">
							...
							<div class="ui-slider-horizontal jui-slider-range ui-slider-primary ui-slider-solid ui-slider-lg mb-4" data-fouc></div>
							<div class="ui-slider-horizontal jui-slider-range ui-slider-danger ui-slider-solid mb-4" data-fouc></div>
							<div class="ui-slider-horizontal jui-slider-range ui-slider-success ui-slider-solid ui-slider-sm mb-1" data-fouc></div>
						</div>
					</div>
