					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Color system">
								...
								<li class="nav-item"><a href="colors_blue.html" class="nav-link active">Blue palette</a></li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Colors</span> - Blue Palette</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="colors_blue.html" class="breadcrumb-item">Colors</a>
			    ...
			    <div class="row">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue">
							<div class="text-center">
								...
								<p class="mb-3 text-muted">Using <code>.border-blue</code> or classes</p>
							</div>

							<input type="text" class="form-control border-blue border-2" placeholder="Input field border">
						</div>
			    	</div>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue">
							...
							<input type="text" class="form-control bg-blue border-blue" placeholder="Input field background">
						</div>
			    	</div>
			    </div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue">
							...
							<div class="form-group-feedback form-group-feedback-right">
								<input type="text" class="form-control bg-blue border-blue" placeholder="Input with icon feedback">
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue">
							...
							<select class="form-control bg-blue border-blue">
			    ...
			    <div class="row">
			    		...
			    		<div class="card card-body border-top-blue">
							...
							<div class="input-group">
								<span class="input-group-prepend">
									<span class="input-group-text bg-blue border-blue"><i class="icon-menu7"></i></span>
								</span>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue">
							...
							<div class="input-group">
								<span class="input-group-prepend">
									<span class="input-group-text bg-blue-700 border-blue-700"><i class="icon-lock2"></i></span>	
								</span>
								<input type="text" class="form-control bg-blue border-blue" placeholder="Solid background color">
								<span class="input-group-append">
									<button class="btn bg-blue-700" type="button"><i class="icon-help"></i></button>
								</span>
							</div>
						</div>
			    	</div>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue">
							...
							<select class="form-control form-control-select2" data-container-css-class="bg-blue" data-fouc>
								<optgroup label="Mountain Time Zone">
									<option value="AZ">Arizona</option>
									<option value="CO">Colorado</option>
									<option value="ID">Idaho</option>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue">
							...
							<select class="form-control form-control-select2" data-dropdown-css-class="bg-blue" data-fouc>
								<optgroup label="Mountain Time Zone">
									<option value="AZ">Arizona</option>
									<option value="CO">Colorado</option>
									<option value="ID">Idaho</option>
			    	...
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue">
							...
							<select class="form-control form-control-select2" data-placeholder="Select a state" data-container-css-class="bg-blue" multiple="multiple" data-fouc>
								<optgroup label="Mountain Time Zone">
									<option value="AZ">Arizona</option>
									<option value="CO">Colorado</option>
			    ...
			    <div class="row">
			    	<div class="col-md-4">
			    		<div class="card card-body border-top-blue">
							...
							<select class="form-control form-control-select2" data-container-css-class="bg-blue" data-dropdown-css-class="bg-blue" data-fouc>
								<optgroup label="Mountain Time Zone">
									<option value="AZ">Arizona</option>
									<option value="CO">Colorado</option>
									<option value="ID">Idaho</option>
			    	...
			    	<div class="col-md-6">
			    		<div class="card">
							...
							<div class="card-body">
								...
								<div class="tab-content card card-body bg-blue rounded-top-0 border-x-0 border-bottom-0 mb-0">
