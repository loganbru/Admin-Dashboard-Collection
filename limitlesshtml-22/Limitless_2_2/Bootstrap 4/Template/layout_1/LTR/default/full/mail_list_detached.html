							...
							<ul class="nav nav-group-sub" data-submenu-title="Application pages">
								...
								<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
									...
									<ul class="nav nav-group-sub">
										...
										<li class="nav-item"><a href="mail_list_detached.html" class="nav-link active">Mail list (detached)</a></li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Mailbox</span> - List Detached</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="mail_list_detached.html" class="breadcrumb-item">Mailbox</a>
