		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Sidebars</span> - Main Light</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="sidebar_default_color_light.html" class="breadcrumb-item">Sidebars</a>
							<span class="breadcrumb-item active">Main light</span>
						</div>
			...
			<div class="content">
				...
				<div class="alert alert-info bg-white alert-styled-left alert-arrow-left alert-dismissible">
					...
					<h6 class="alert-heading font-weight-semibold mb-1">Light main sidebar</h6>
					All sidebars support light and dark color palettes. By default main sidebar is dark, if you want to make it white change <code>.sidebar-dark</code> class to <code>.sidebar-light</code>. Some text color adjustments might be needed.
			    </div>
			    <!-- /info alert -->
