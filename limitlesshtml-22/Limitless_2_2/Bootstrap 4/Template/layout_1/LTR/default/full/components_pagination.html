					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Basic components">
								...
								<li class="nav-item"><a href="components_pagination.html" class="nav-link active">Pagination</a></li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Components</span> - Pagination</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="components_pagination.html" class="breadcrumb-item">Components</a>
				...
				<div class="row">
					...
					<div class="col-lg-4">
						<div class="card card-body border-top-teal text-center">
							...
							<ul class="pagination pagination-separated align-self-center">
								<li class="page-item"><a href="#" class="page-link"><i class="icon-arrow-left32 mr-2"></i> Prev</a></li>
								<li class="page-item active"><a href="#" class="page-link">1</a></li>
								<li class="page-item"><a href="#" class="page-link">2</a></li>
								<li class="page-item disabled"><a href="#" class="page-link">3</a></li>
								<li class="page-item"><a href="#" class="page-link">4</a></li>
								<li class="page-item"><a href="#" class="page-link">Next <i class="icon-arrow-right32 ml-2"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
