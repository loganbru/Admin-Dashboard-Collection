...
<body>
	...
	<!-- Alternative navbar -->
	<div class="navbar navbar-expand-md navbar-dark bg-teal-400 navbar-static border-transparent">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Navbars">
								...
								<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
									...
									<ul class="nav nav-group-sub">
										<li class="nav-item"><a href="navbar_multiple_top_static.html" class="nav-link active">Multiple top static</a></li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Multiple Navbars</span> - Top Static</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="navbar_multiple_top_static.html" class="breadcrumb-item">Multiple navbars</a>
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="mb-4">
							...
							<div class="navbar navbar-expand-xl navbar-light bg-light rounded-bottom" style="border-left: 1px solid rgba(0,0,0,0.125); border-right: 1px solid rgba(0,0,0,0.125);">
								<div class="text-center d-xl-none w-100">
