					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Navbars">
								...
								<li class="nav-item"><a href="navbar_components.html" class="nav-link active">Navbar components</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Navbars</span> - Components</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="navbar_components.html" class="breadcrumb-item">Navbars</a>
						...
						<div class="mb-4">
							...
							<div class="navbar navbar-expand-xl navbar-dark bg-slate-700 navbar-component rounded" style="z-index: 27;">
								...
								<div class="navbar-collapse collapse" id="navbar-navigation">
									<ul class="navbar-nav">
										<li class="nav-item"><a href="#" class="navbar-nav-link active">Active link</a></li>
							...
							<div class="navbar-collapse collapse" id="navbar-form-selects">
								<form class="my-3 my-xl-0">
									<div class="wmin-xl-200">
										<select class="form-control form-input-styled wmin-xl-200" data-fouc>
								...
								<form class="mb-3 mb-xl-0 ml-xl-auto">
									<select class="form-control wmin-xl-200">
										<option value="">Select your state</option>
										<option value="AK">Alaska</option>
										<option value="HI">Hawaii</option>
										<option value="CA">California</option>
