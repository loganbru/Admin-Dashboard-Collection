							...
							<ul class="nav nav-group-sub" data-submenu-title="Application pages">
								...
								<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
									...
									<ul class="nav nav-group-sub">
										...
										<li class="nav-item"><a href="chat_options.html" class="nav-link active">Chat options</a></li>
									</ul>
								</li>
								<li class="nav-item nav-item-submenu">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Conversation</span> - Options</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="chat_options.html" class="breadcrumb-item">Conversation</a>
				...
				<div>
					<div class="nav-tabs-responsive">
						<ul class="nav nav-tabs nav-tabs-highlight flex-nowrap mb-0">
							<li class="nav-item">
								<a href="#james" class="nav-link active" data-toggle="tab">
