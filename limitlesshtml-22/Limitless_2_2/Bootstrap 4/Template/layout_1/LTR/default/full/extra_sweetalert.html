					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Extra components">
								...
								<li class="nav-item"><a href="extra_sweetalert.html" class="nav-link active">SweetAlert notifications</a></li>
								<li class="nav-item-divider"></li>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="extra_sweetalert.html" class="breadcrumb-item">Extra</a>
