					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Dimple library">
								...
								<li class="nav-item"><a href="dimple_bubble.html" class="nav-link active">Bubble charts</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Dimple</span> - Bubble Charts</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="dimple_bubble.html" class="breadcrumb-item">Dimple</a>
