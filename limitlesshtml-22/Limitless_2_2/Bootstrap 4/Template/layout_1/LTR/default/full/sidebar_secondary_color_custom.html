							...
							<ul class="nav nav-group-sub" data-submenu-title="Sidebars">
								...
								<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
									...
									<ul class="nav nav-group-sub">
										...
										<li class="nav-item"><a href="sidebar_secondary_color_custom.html" class="nav-link active">Custom color</a></li>
									</ul>
								</li>
								<li class="nav-item nav-item-submenu">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Sidebars</span> - Secondary Custom</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="sidebar_secondary_custom.html" class="breadcrumb-item">Sidebars</a>
