							...
							<ul class="nav nav-group-sub" data-submenu-title="Navbars">
								...
								<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
									...
									<ul class="nav nav-group-sub">
										...
										<li class="nav-item"><a href="navbar_component_multiple.html" class="nav-link active">Multiple navbars</a></li>
									</ul>
								</li>
								<li class="nav-item-divider"></li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Content Navbar</span> - Multiple</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="navbar_content_multiple.html" class="breadcrumb-item">Content navbar</a>
							...
							<div class="navbar navbar-expand-xl navbar-dark navbar-component mb-0 rounded-top">
								...
								<div class="navbar-collapse collapse" id="navbar-demo1-mobile">
									<ul class="nav navbar-nav">
										<li class="nav-item">
											<a href="#" class="navbar-nav-link active"><i class="icon-git-branch mr-2"></i> Branches</a>
										</li>
										<li class="nav-item">
