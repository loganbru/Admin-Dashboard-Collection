...
gulp.task('demo11:sass:assets', function() {
	console.log('Command executed successfully compiling SCSS in assets.');
	 return gulp.src('ltr/demo11/sass-light/assets/**/*.scss') // Gets all files ending with .scss in ltr/scss and children dirs
	    .pipe(sass())
	    .pipe(gulp.dest('ltr/demo11/assets/css'))
	    .pipe(browserSync.reload({
	      stream: true
	}))
})
...
gulp.task('demo11:sass:plugins', function() {
	console.log('Command executed successfully compiling SCSS in plugin.');
  return gulp.src('ltr/demo11/sass-light/plugins/**/*.scss') // Gets all files ending with .scss in ltr/scss and children dirs
    .pipe(sass())
    .pipe(gulp.dest('ltr/demo11/plugins/'))
    .pipe(browserSync.reload({
      stream: true
    }))
})
...
gulp.task('demo11-dark:sass:assets', function() {
	console.log('Command executed successfully compiling SCSS in assets.');
	 return gulp.src('ltr/demo11/sass-dark/assets/**/*.scss') // Gets all files ending with .scss in ltr/scss and children dirs
	    .pipe(sass())
	    .pipe(gulp.dest('ltr/demo11/dark/assets/css'))
	    .pipe(browserSync.reload({
	      stream: true
	}))
})
...
gulp.task('demo11-dark:sass:plugins', function() {
	console.log('Command executed successfully compiling SCSS in plugin.');
  return gulp.src('ltr/demo11/sass-dark/plugins/**/*.scss') // Gets all files ending with .scss in ltr/scss and children dirs
    .pipe(sass())
    .pipe(gulp.dest('ltr/demo11/dark/plugins/'))
    .pipe(browserSync.reload({
      stream: true
    }))
})
...
gulp.task('demo11-rtl:sass:assets', function() {
	console.log('Command executed successfully compiling SCSS in assets.');
	 return gulp.src('rtl/demo11/sass-light/assets/**/*.scss') // Gets all files ending with .scss in rtl/scss and children dirs
	    .pipe(sass())
	    .pipe(gulp.dest('rtl/demo11/assets/css'))
	    .pipe(browserSync.reload({
	      stream: true
	}))
})
...
gulp.task('demo11-rtl:sass:plugins', function() {
	console.log('Command executed successfully compiling SCSS in plugin.');
  return gulp.src('rtl/demo11/sass-light/plugins/**/*.scss') // Gets all files ending with .scss in rtl/scss and children dirs
    .pipe(sass())
    .pipe(gulp.dest('rtl/demo11/plugins/'))
    .pipe(browserSync.reload({
      stream: true
    }))
})
...
gulp.task('demo11-rtl-dark:sass:assets', function() {
	console.log('Command executed successfully compiling SCSS in assets.');
	 return gulp.src('rtl/demo11/sass-dark/assets/**/*.scss') // Gets all files ending with .scss in rtl/scss and children dirs
	    .pipe(sass())
	    .pipe(gulp.dest('rtl/demo11/dark/assets/css'))
	    .pipe(browserSync.reload({
	      stream: true
	}))
})
...
gulp.task('demo11-rtl-dark:sass:plugins', function() {
	console.log('Command executed successfully compiling SCSS in plugin.');
  return gulp.src('rtl/demo11/sass-dark/plugins/**/*.scss') // Gets all files ending with .scss in rtl/scss and children dirs
    .pipe(sass())
    .pipe(gulp.dest('rtl/demo11/dark/plugins/'))
    .pipe(browserSync.reload({
      stream: true
    }))
})
...
gulp.task('watch:demo11',  gulp.series(function() {
	...
	var html = gulp.watch('ltr/demo11');
	html.on('change', function(path, stats) {
	    browserSync.notify("Compiling, please wait!");
	    browserSync.reload("*.html");
	})
	...
	var js = gulp.watch('ltr/demo11/**/*.js');
	  js.on('change', function(path, stats) {
	    browserSync.notify("Compiling, please wait!");
	    browserSync.reload("*.js");
	})
	...
	// var css = gulp.watch('ltr/demo11/**/*.css');
	// css.on('change', function(path, stats) {
	//     browserSync.notify("Injecting CSS!");
	//     browserSync.reload("*.css");
	// })
	...
	var scss = gulp.watch('ltr/demo11/**/*.scss', gulp.series('demo11:sass:assets', 'demo11:sass:plugins', 'demo11-dark:sass:assets', 'demo11-dark:sass:plugins'));
	scss.on('change', function(path, stats) {
	    browserSync.notify("Injecting SCSS!");
	    browserSync.reload("*.scss");
	})
...
gulp.task('watch:demo11-rtl',  gulp.series(function() {
	...
	var html = gulp.watch('rtl/demo11');
	html.on('change', function(path, stats) {
	    browserSync.notify("Compiling, please wait!");
	    browserSync.reload("*.html");
	})
	...
	var js = gulp.watch('rtl/demo11/**/*.js');
	  js.on('change', function(path, stats) {
	    browserSync.notify("Compiling, please wait!");
	    browserSync.reload("*.js");
	})
	...
	// var css = gulp.watch('rtl/demo11/**/*.css');
	// css.on('change', function(path, stats) {
	//     browserSync.notify("Injecting CSS!");
	//     browserSync.reload("*.css");
	// })
	...
	var scss = gulp.watch('rtl/demo11/**/*.scss', gulp.series('demo11-rtl:sass:assets', 'demo11-rtl:sass:plugins', 'demo11-rtl-dark:sass:assets', 'demo11-rtl-dark:sass:plugins'));
	scss.on('change', function(path, stats) {
	    browserSync.notify("Injecting SCSS!");
	    browserSync.reload("*.scss");
	})
