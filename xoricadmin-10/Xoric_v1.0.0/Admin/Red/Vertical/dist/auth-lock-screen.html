...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Lock Screen | Xoric - Responsive Bootstrap 4 Admin Dashboard</title>
                                    ...
                                    <form class="form-horizontal" action="index.html">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="mt-4">
                                                    <button class="btn btn-success btn-block waves-effect waves-light" type="submit">Unlock</button>
                                                </div>
                                                <div class="mt-4 text-center">
                                                    <p class="mb-0">Not you ? return <a href="auth-login.html" class="font-weight-medium text-primary"> Sign In </a> </p>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
