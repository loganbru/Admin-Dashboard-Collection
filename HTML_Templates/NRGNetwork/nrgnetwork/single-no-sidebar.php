        ...
        <div class="blog-wrapper blog-list blog-fullwith">
            ...
            <div class="row">
                <div class="col-xs-12 col-md-10 col-md-offset-1">
                    ...
                    <div class="blog-post be-large-post type-2">
                        <div class="info-block clearfix">
                            <div class="be-large-post-align">
                                ...
                                <a href="<?php the_permalink(); ?>#be-comment-block"><i class="fa fa-comment-o"></i> <?php comments_number('0', '1', '%'); ?></a>                                <div class="be-text-tags">
                    ...
                    <div class="row">
                        <?php echo TPL::get_prev_post(); ?> 
                        <?php echo TPL::get_next_post(); ?>                                                    
                    </div>
