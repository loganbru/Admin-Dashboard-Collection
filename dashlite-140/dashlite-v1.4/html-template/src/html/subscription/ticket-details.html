...
<head>
    ...
    <!-- Page Title  -->
    <title>Request Detail | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                            ...
                            <div class="nk-content-body">
                                <div class="nk-content-wrap">
                                    <div class="nk-block-head">
                                        <div class="nk-block-head-sub"><a class="back-to" href="html/subscription/tickets.html"><em class="icon ni ni-arrow-left"></em><span>My Tickets</span></a></div>
                                        <div class="nk-block-between-md g-4 align-items-end">
                                            <div class="nk-block-head-content">
                                                <h2 class="nk-block-title fw-normal">Request for approve payment</h2>
                                            </div>
                                            <div class="nk-block-head-content">
                                                    ...
                                                    <div class="ticket-msg-item">
                                                        <div class="ticket-msg-from">
                                                            <div class="ticket-msg-user user-card">
                                                                ...
                                                                <div class="user-info">
                                                                    <span class="lead-text">Kenneth Anderson</span>
                                                                    <span class="text-soft">Customer</span>
                                                                </div>
                                                            </div>
                                                            <div class="ticket-msg-date">
                                                                <span class="sub-text">Jan 26, 2020 6:00 AM</span>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="ticket-msg-item is-mine">
                                                        ...
                                                        <div class="ticket-msg-attach">
                                                            ...
                                                            <ul class="ticket-msg-attach-list">
                                                                <li>
                                                                    <a href="#">
                                                                        <img src="./images/gfx/attach-a.jpg" alt="">
                                                                        <em class="icon ni ni-download"></em>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="#">
                                                                        <img src="./images/gfx/attach-b.jpg" alt="">
                                                                        <em class="icon ni ni-download"></em>
                                                                    </a>
                                                                </li>
                                                            </ul>
