                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!-- /.modal -->
                                <img src="../assets/images/alert/model2.png" alt="default" data-toggle="modal" data-target=".long-modal" class="model_img img-responsive" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!-- /.modal -->
                                <img src="../assets/images/alert/model.png" alt="default" data-toggle="modal" data-target="#verticalcenter" class="model_img img-responsive" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!-- /.modal -->
                                <img src="../assets/images/alert/model.png" alt="default" data-toggle="modal" data-target="#tooltipmodals" class="model_img img-responsive" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!-- /.modal -->
                                <img src="../assets/images/alert/model.png" alt="default" data-toggle="modal" data-target="#grid-modal" class="model_img img-responsive" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
