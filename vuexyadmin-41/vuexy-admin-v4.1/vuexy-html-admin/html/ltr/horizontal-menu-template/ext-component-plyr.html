...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../../app-assets/vendors/css/extensions/plyr.css">
    <!-- END: Vendor CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="../../../app-assets/css/plugins/extensions/media-plyr.css">
    <!-- END: Page CSS-->
...
<body class="horizontal-layout horizontal-menu 2-columns  navbar-floating footer-static  " data-open="hover" data-menu="horizontal-menu" data-col="2-columns">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown" data-i18n="Extensions"><i class="feather icon-box"></i>Extensions</a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="active" data-menu=""><a class="dropdown-item" href="ext-component-plyr.html" data-toggle="dropdown" data-i18n="Media Player"><i class="feather icon-circle"></i>Media Player</a>
                                    </li>
    ...
    <script src="../../../app-assets/vendors/js/media/plyr.js"></script>
    <script src="../../../app-assets/vendors/js/media/plyr.polyfilled.js"></script>
    <!-- END: Page Vendor JS-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="../../../app-assets/js/scripts/extensions/media-plyr.js"></script>
    <!-- END: Page JS-->
